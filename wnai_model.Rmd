...
```{r}
dat2 <- data.frame(precip = dat$MonthlyMeanPrecip,
                   ...
                   plants = dat$Plant_Richness
                   )
```

## Model 1: Plants

Causal link to be tested: `plant ~ density`
...
There are also two potential colliders (`animal` and `agri`), which should be avoided. As long as we leave these alone, we don't introduce any correlation
